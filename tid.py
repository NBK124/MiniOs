...
jackal_INFO = 'Скопируйте png файл в папку с этой программой с названием "before.png". Совет — используйте только png файлы, другие типы файлов лучше не переименовывайте.'
